...
const { autoreadCommand, isAutoreadEnabled, handleAutoread } = require('./SAYAN/autoread');
...
const { autoStatusCommand, handleStatusUpdate } = require('./SAYAN/autostatus');
...
const songCommand = require('./SAYAN/song');
...
const updateCommand = require('./SAYAN/update');
        ...
        if (message.message?.buttonsResponseMessage) {
            ...
            if (buttonId === 'channel') {
                await sock.sendMessage(chatId, { 
                    text: '📢 *Join our Channel:*\nhttps://whatsapp.com/channel/0029VbBYK1T0gcfRPEoYUT1p' 
                }, { quoted: message });
                return;
                ...
                await sock.sendMessage(chatId, { 
                    text: `🔗 *Support*\n\nhttps://chat.whatsapp.com/BirhXls7P1TBfChPYhhJWt` 
                }, { quoted: message });
                return;
            }
        }
